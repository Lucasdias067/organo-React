...
function App() {
  ...
  function deletarColaborador(id: string) {
    setColaboradores(colaboradores.filter(co => co.id !== id))
  }
  ...
  function favoritar(id: string) {
    setColaboradores(colaboradores.map(co => {
      if (co.id === id) co.favorito = !co.favorito
      return co
    }))
  }
  ...
  return (
    <div>
      ...
      <Formulario
        ...
        cadastrarTime={time => setTimes([...times, time])}
      />
